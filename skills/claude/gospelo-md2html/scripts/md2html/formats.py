...
class PageFormat:
    ...
    is_slide: bool
    default_columns: str  # "split" | "single"
...
FORMATS: dict[str, PageFormat] = {
    ...
    "a4-landscape": PageFormat("a4-landscape", 297.0, 210.0, 16.0, 20.0, 11.0, False, "split"),
    "a3": PageFormat("a3", 297.0, 420.0, 22.0, 22.0, 12.0, False, "single"),
    "a3-landscape": PageFormat("a3-landscape", 420.0, 297.0, 20.0, 24.0, 12.0, False, "split"),
    "16x9": PageFormat("16x9", 338.6667, 190.5, 10.0, 12.0, 14.0, True, "split"),
    "4x3": PageFormat("4x3", 254.0, 190.5, 10.0, 12.0, 14.0, True, "split"),
}
